...
double getYCbCr_422_PSNR(unsigned short *im0, unsigned short* im1, const int NR,
                         const int NC, const int NCOMP, const int N) {

  unsigned short *im0_y, *im1_y, *im0_cb, *im1_cb, *im0_cr, *im1_cr;
